...
<img src="media/nanoplot_histogram.PNG" width="400">
...
In this section you will use a tool called 'Unicycler' to create a draft genome assembly from Illumina and Nanopore reads. <br />
