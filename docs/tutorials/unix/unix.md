...
!!! warning "Deprecated"
    ...
    **This workshop has been deprecated. For the current version, please visit [https://melbournebioinformatics.github.io/intro-to-unix/](https://melbournebioinformatics.github.io/intro-to-unix/).**
